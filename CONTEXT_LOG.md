...
*   2.3. Идентификация покупателя: В связи с Российским законодательством и рассматриваемом законопроекте об онлайн продаже и доставке алкогольной продукции, покупателю для оформления доставки необходимо подтвердить личность через единую биометрическую систему (ЕБС). Таким образом, покупатель имеет право:
...
## Текущие проблемы
*   Папка `ebs_plugin` не отслеживается Git'ом.
*   Ошибки с версией Gradle.
*   Ошибки с кэшем Android Studio.

## Текущие решения
*   Удалить папку `ebs_plugin`.
