...
@JsonKey(includeIfNull: false) String? get id;@JsonKey(name: 'winery_id') String get wineryId;@JsonKey(name: 'wineries') Winery? get winery; String get name; String? get description; String? get grapeVariety;@JsonKey(name: 'image_url') String? get imageUrl;@JsonKey(unknownEnumValue: WineColor.unknown, fromJson: _stringToWineColor, toJson: _wineColorToString) WineColor? get color;@JsonKey(unknownEnumValue: WineType.unknown, fromJson: _stringToWineType, toJson: _wineTypeToString) WineType? get type;@JsonKey(unknownEnumValue: WineSugar.unknown, fromJson: _stringToWineSugar, toJson: _wineSugarToString) WineSugar? get sugar; int? get vintage;@JsonKey(name: 'alcohol_level') double? get alcoholLevel; double? get rating;@JsonKey(name: 'serving_temperature') String? get servingTemperature;@JsonKey(name: 'sweetness') int? get sweetness;@JsonKey(name: 'acidity') int? get acidity;@JsonKey(name: 'tannins') int? get tannins;@JsonKey(name: 'saturation') int? get saturation;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;@JsonKey(name: 'is_deleted') bool get isDeleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,wineryId,winery,name,description,grapeVariety,imageUrl,color,type,sugar,vintage,alcoholLevel,rating,servingTemperature,sweetness,acidity,tannins,saturation,createdAt,updatedAt,isDeleted]);

@override
String toString() {
  return 'Wine(id: $id, wineryId: $wineryId, winery: $winery, name: $name, description: $description, grapeVariety: $grapeVariety, imageUrl: $imageUrl, color: $color, type: $type, sugar: $sugar, vintage: $vintage, alcoholLevel: $alcoholLevel, rating: $rating, servingTemperature: $servingTemperature, sweetness: $sweetness, acidity: $acidity, tannins: $tannins, saturation: $saturation, createdAt: $createdAt, updatedAt: $updatedAt, isDeleted: $isDeleted)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? id,@JsonKey(name: 'winery_id') String wineryId,@JsonKey(name: 'wineries') Winery? winery, String name, String? description, String? grapeVariety,@JsonKey(name: 'image_url') String? imageUrl,@JsonKey(unknownEnumValue: WineColor.unknown, fromJson: _stringToWineColor, toJson: _wineColorToString) WineColor? color,@JsonKey(unknownEnumValue: WineType.unknown, fromJson: _stringToWineType, toJson: _wineTypeToString) WineType? type,@JsonKey(unknownEnumValue: WineSugar.unknown, fromJson: _stringToWineSugar, toJson: _wineSugarToString) WineSugar? sugar, int? vintage,@JsonKey(name: 'alcohol_level') double? alcoholLevel, double? rating,@JsonKey(name: 'serving_temperature') String? servingTemperature,@JsonKey(name: 'sweetness') int? sweetness,@JsonKey(name: 'acidity') int? acidity,@JsonKey(name: 'tannins') int? tannins,@JsonKey(name: 'saturation') int? saturation,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'is_deleted') bool isDeleted
});
...
/// Create a copy of Wine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? wineryId = null,Object? winery = freezed,Object? name = null,Object? description = freezed,Object? grapeVariety = freezed,Object? imageUrl = freezed,Object? color = freezed,Object? type = freezed,Object? sugar = freezed,Object? vintage = freezed,Object? alcoholLevel = freezed,Object? rating = freezed,Object? servingTemperature = freezed,Object? sweetness = freezed,Object? acidity = freezed,Object? tannins = freezed,Object? saturation = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? isDeleted = null,}) {
...
as double?,servingTemperature: freezed == servingTemperature ? _self.servingTemperature : servingTemperature // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Wine() when $default != null:
return $default(_that.id,_that.wineryId,_that.winery,_that.name,_that.description,_that.grapeVariety,_that.imageUrl,_that.color,_that.type,_that.sugar,_that.vintage,_that.alcoholLevel,_that.rating,_that.servingTemperature,_that.sweetness,_that.acidity,_that.tannins,_that.saturation,_that.createdAt,_that.updatedAt,_that.isDeleted);case _:
  return orElse();
...
class _Wine implements Wine {
  const _Wine({@JsonKey(includeIfNull: false) this.id, @JsonKey(name: 'winery_id') required this.wineryId, @JsonKey(name: 'wineries') this.winery, required this.name, this.description, this.grapeVariety, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(unknownEnumValue: WineColor.unknown, fromJson: _stringToWineColor, toJson: _wineColorToString) this.color, @JsonKey(unknownEnumValue: WineType.unknown, fromJson: _stringToWineType, toJson: _wineTypeToString) this.type, @JsonKey(unknownEnumValue: WineSugar.unknown, fromJson: _stringToWineSugar, toJson: _wineSugarToString) this.sugar, this.vintage, @JsonKey(name: 'alcohol_level') this.alcoholLevel, this.rating, @JsonKey(name: 'serving_temperature') this.servingTemperature, @JsonKey(name: 'sweetness') this.sweetness, @JsonKey(name: 'acidity') this.acidity, @JsonKey(name: 'tannins') this.tannins, @JsonKey(name: 'saturation') this.saturation, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'is_deleted') this.isDeleted = false});
...
@override@JsonKey(name: 'wineries') final  Winery? winery;
