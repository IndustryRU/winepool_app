...
@useResult
$Res call({
 String id,@JsonKey(defaultValue: '') String? orderId,@JsonKey(name: 'offer_id') String? offerId, int? quantity,@JsonKey(name: 'price_at_purchase') double? priceAtPurchase, Offer? offer
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(defaultValue: '')  String? orderId, @JsonKey(name: 'offer_id')  String? offerId,  int? quantity, @JsonKey(name: 'price_at_purchase')  double? priceAtPurchase,  Offer? offer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(defaultValue: '')  String? orderId, @JsonKey(name: 'offer_id')  String? offerId,  int? quantity, @JsonKey(name: 'price_at_purchase')  double? priceAtPurchase,  Offer? offer)  $default,) {final _that = this;
switch (_that) {
case _OrderItem():
return $default(_that.id,_that.orderId,_that.offerId,_that.quantity,_that.priceAtPurchase,_that.offer);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(defaultValue: '')  String? orderId, @JsonKey(name: 'offer_id')  String? offerId,  int? quantity, @JsonKey(name: 'price_at_purchase')  double? priceAtPurchase,  Offer? offer)?  $default,) {final _that = this;
switch (_that) {
case _OrderItem() when $default != null:
return $default(_that.id,_that.orderId,_that.offerId,_that.quantity,_that.priceAtPurchase,_that.offer);case _:
  return null;
...
class _OrderItem implements OrderItem {
  const _OrderItem({required this.id, @JsonKey(defaultValue: '') this.orderId, @JsonKey(name: 'offer_id') this.offerId, this.quantity, @JsonKey(name: 'price_at_purchase') this.priceAtPurchase, this.offer});
