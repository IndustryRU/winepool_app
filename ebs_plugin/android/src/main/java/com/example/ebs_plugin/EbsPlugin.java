...
public class EbsPlugin implements FlutterPlugin, ActivityAware, NativeApi.NativeHostApi, PluginRegistry.ActivityResultListener {
  ...
  public void isInstalledApp(@NonNull NativeApi.Result<Boolean> result) {
    try {
      boolean isAppInstalled = ru.rtlabs.mobile.ebs.sdk.adapter.EbsApi.isInstalledApp(activity);
  ...
  public void getAppName(@NonNull NativeApi.Result<String> result) {
    try {
      String appName = ru.rtlabs.mobile.ebs.sdk.adapter.EbsApi.getAppName(activity);
  ...
  public void getRequestInstallAppText(@NonNull NativeApi.Result<String> result) {
    try {
      String text = ru.rtlabs.mobile.ebs.sdk.adapter.EbsApi.getRequestInstallAppText(activity);
      result.success(text);
    } catch (Exception e) {
  ...
  public void requestInstallApp(@NonNull NativeApi.Result<Boolean> result) {
    try {
      ru.rtlabs.mobile.ebs.sdk.adapter.EbsApi.requestInstallApp(activity);
      result.success(true);
    } catch (Exception e) {
